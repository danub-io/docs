...
description: "Tables, indexes, and relationships of the shared Turso database between tribarato_be and tribarato_fe"
---

The tribarato ecosystem uses a single shared **Turso (distributed SQLite)** database, shared between the backend (write) and frontend (SSR read).

> Original documentation: [tribarato_be/docs/architecture/database-schema.md](tribarato_be/docs/architecture/database-schema.md)
