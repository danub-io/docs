---
title: "Data Layer — tribarato Frontend"
---
...
tribarato_fe queries the Turso database **directly** in Server-Side Rendering (SSR) via the `@libsql/client` driver. There is no intermediate REST API layer — the backend (tribarato_be) writes data, and the frontend reads it.
